...
const SignUp = ({majorProps}) => {
    ...
    return (
        <>
            <section
                className="bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-rose-400 via-fuchsia-500 to-white grid">
        <span className="">
          <img
              className="scale-[0.7] z-0 absolute -left-[-50px] -top-[500px]"
          ...
          />
                ...
                <div
                    className="flex flex-col items-center justify-center px-6 py-8 mx-auto w-full md:h-screen lg:py-0 z-10">
