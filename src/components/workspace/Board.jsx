...
const DropDownHamburger = dynamic(() => import("../hamburger/DropDown.Hamburger"));
...
export default function Board({listProps, usernameProps, TeamInfo}) {
    ...
    return (<div className="flex pt-6 overflow-auto h-full">
                                                    ...
                                                    {(provided, snapshot) => {
                                                        ...
                                                        >
                                                            <TaskCard
                                                                ...
                                                                usernameProps={usernameProps}
                                                                tag1={<button
                                                                    className="text-slate-800 hover:text-blue-600 text-sm bg-white hover:bg-slate-100 border border-slate-200 rounded-l-lg font-medium w-full  px-4 py-2 inline-flex space-x-1 items-center justify-center">
                                            <span>
                                              <svg
                                                  className="w-4 h-4"
                                                  fill="none"
