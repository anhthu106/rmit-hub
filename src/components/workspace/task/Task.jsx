                ...
                <>
                    <div className="fixed inset-0 z-10 overflow-y-auto cursor-pointer">
                        ...
                        <div className="flex items-center min-h-screen md:px-40 px-4 py-16 cursor-auto">
                            <div
                                className="relative max-h-screen w-screen md:w-2/3 p-4 mx-auto bg-white rounded-md shadow-lg">
                                <div className="mt-2 text-center sm:ml-4 sm:text-left">
                                    <div className="flex items-center justify-between mt-3 mb-2 sm:px-auto">
                                        <div
                                            className="flex py-1  leading-tight tracking-tight text-gray-900 font-semibold text-sm md:text-base rounded cursor-default	">
                                            <svg
